...
public class Pkcs12OidcMtlsIT extends KeycloakMtlsAuthN {
    ...
    @KeycloakContainer(image = "quay.io/keycloak/keycloak:22.0.1", command = KC_DEV_MODE_P12_CMD, port = KEYCLOAK_PORT)
    ...
    private static boolean cannotRunOnFIPS() throws IOException, InterruptedException {
